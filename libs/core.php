...
class Context extends Object {
	...
	public function __construct($data = array()) {
		...
		$this->setAttribute('param', $params);
	}
	...
	public function setParameter($name, $value) {
		...
		$this->setAttribute('param', $this->request->getAttributes());
	}
	
	public function setParameters($params = array()) {
		$this->setAttribute('param', $this->request->data($params));
	}
...
class ComponentLoader {
	...
	public static function loadComponent($name, $paths = null) {
		...
		Log::error('Component not found - ' . $componentClass . '(' . implode(',', $paths) . ')');
	...
	public static function getDB($db_config = array()) {
		...
		include_once LIB_PATH . 'database/db.php';
